...
| `opt-regresion-formas.png` | Cinco familias generadoras simuladas, cada una con tres ajustes polinomiales calculados de las mismas muestras. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-sobreajuste.png` | Datos lineales y cuadráticos simulados: relación generadora, ajuste correcto, grado 15 y validación independiente. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-validacion.png` | RMSE de entrenamiento y validación para grados enteros 1 a 16 de los mismos experimentos lineal y cuadrático. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
