...
| `opt-regresion-grado.svg` | Ajustes polinomiales y RMSE calculado sobre los mismos puntos observados. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_optimizacion.py`; datos didácticos propios | Propio, CC BY-SA 4.0 |
...
| `opt-regresion-error-grado.png` | RMSE sobre los mismos 120 puntos observados para grados enteros 1 a 16 de las relaciones lineal y cuadrática. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
