...
| `opt-juego-turnos.svg` | Árbol de nueve estados: turnos propios y rivales, acciones y utilidades finales. Página 6.5.4: `5_practica_de_modelado/4_juego_practica.md` | Generado con `tools/gen_optimizacion.py` | Propio, CC BY-SA 4.0 |
