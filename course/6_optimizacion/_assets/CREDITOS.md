...
| `opt-juego-turnos.svg` | Árbol de nueve estados: turnos propios y rivales, acciones y utilidades finales. Página 6.5.5: `5_practica_de_modelado/5_juego_practica.md` | Generado con `tools/gen_optimizacion.py` | Propio, CC BY-SA 4.0 |
| `opt-clasificacion-alfa.svg` | Pérdida y aciertos frente al intercepto real α con β=0; tres reglas constantes elegidas a mano. Página 6.5.3: `5_practica_de_modelado/3_clasificacion_practica.md` | Generado con `tools/gen_optimizacion.py` | Propio, CC BY-SA 4.0 |
| `opt-clasificacion-accuracy.svg` | Accuracy calculada para cuatro casos al variar α con β=1 fija solo en la visualización. Página 6.5.3: `5_practica_de_modelado/3_clasificacion_practica.md` | Generado con `tools/gen_optimizacion.py` | Propio, CC BY-SA 4.0 |
| `opt-regresion-residuos.svg` | Datos de entrega, recta de referencia y residuos verticales. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_optimizacion.py`; datos didácticos propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-perdidas.svg` | Pérdidas puntuales absoluta y cuadrática con sus unidades. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_optimizacion.py`; datos didácticos propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-grado.svg` | Ajustes polinomiales y RMSE de entrenamiento y validación calculados. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_optimizacion.py`; datos didácticos propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-datos.png` | 101 entregas simuladas con siete retrasos atípicos señalados. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-ajustes.png` | Ajustes MAE y RMSE optimizados sobre las mismas 101 entregas; métricas calculadas en ambos paneles. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-pendiente.png` | Pérdidas MAE y RMSE al variar la pendiente con intercepto fijo de 10 minutos. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-forma-lineal.png` | Relación lineal simulada: 120 observaciones y los mismos tres ajustes en el intervalo observado y el ampliado. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-forma-cuadratica.png` | Relación cuadrática simulada: 120 observaciones y los mismos tres ajustes en el intervalo observado y el ampliado. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-forma-cubica.png` | Relación cúbica simulada: 120 observaciones y los mismos tres ajustes en el intervalo observado y el ampliado. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-forma-senoidal.png` | Relación senoidal simulada: 120 observaciones y los mismos tres ajustes en el intervalo observado y el ampliado. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-forma-reciproca.png` | Relación recíproca simulada: 120 observaciones y los mismos tres ajustes en el intervalo observado y el ampliado, sin cruzar cero. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
| `opt-regresion-validacion.png` | RMSE de entrenamiento y validación interior para grados enteros 1 a 16 de los mismos experimentos lineal y cuadrático. Página 6.5.4: `5_practica_de_modelado/4_regresion_practica.md` | Generado con `tools/gen_regresion_experimentos.py`; datos simulados propios | Propio, CC BY-SA 4.0 |
