...
Todo lo anterior en esta unidad cuenta una historia de ideas: mitos, arquitecturas, algoritmos, la alternancia de veranos e inviernos. Esta página cuenta la otra mitad, la del hilo quién paga y quién decide: quién trabaja para que la inteligencia artificial funcione, quién se beneficia, quién carga el costo, y qué visiones del futuro compiten por decidir hacia dónde va el campo. Ninguna de esas preguntas tiene una respuesta limpia. Esa incomodidad es el punto.
...
La automatización mecánica sustituyó músculo: el telar, el tractor, la línea de ensamblaje. La automatización con inteligencia artificial promete sustituir algo distinto —clasificar, resumir, decidir, redactar—, y esa promesa no es nueva. Norbert Wiener la planteó ya en 1950, en *The Human Use of Human Beings*: automatizar el pensamiento podía desplazar empleo intelectual igual que la mecánica había desplazado empleo manual. Setenta años después seguimos haciendo la misma pregunta con otro vocabulario, y respondiéndola con la misma incertidumbre.

El Foro Económico Mundial, con Klaus Schwab a la cabeza, popularizó en 2016 la etiqueta **cuarta revolución industrial** para nombrar este momento, y conviene tomarla en serio en vez de tratarla como jerga de conferencia. La primera revolución industrial mecanizó la producción con la máquina de vapor; la segunda, con la electricidad, hizo posible la manufactura en masa; la tercera, con la computadora e internet, digitalizó la información y el cálculo. Las tres delegaron trabajo físico o trabajo de cómputo mecánico y repetitivo —tejer, ensamblar, sumar—, nunca juicio. Schwab describe la cuarta como una fusión de lo físico, lo digital y lo biológico que avanza a ritmo exponencial; para el argumento de esta unidad, lo distintivo es más simple de nombrar: es la primera vez que se delega trabajo mental —clasificar, resumir, decidir, redactar— y no solo trabajo muscular o trabajo de cómputo mecánico. Eso es lo que hace que la pregunta de Wiener, en 2026, ya no sea hipotética. La tabla siguiente recoge estimaciones publicadas entre 2016 y 2030, de fuentes y metodologías distintas, sobre empleos destruidos y creados por la automatización:
...
El **aceleracionismo de izquierda** tiene un origen textual preciso: el "Manifiesto Aceleracionista" que Alex Williams y Nick Srnicek publicaron en 2013, que reclama la tecnología y la automatización como herramientas para liberar tiempo humano del trabajo asalariado, no para acumular capital. Es autodescripción: los autores firman el manifiesto con ese nombre. El crítico cultural Mark Fisher —cercano a Srnicek y Williams, autor de *Capitalist Realism* (2009)— es la otra voz de este linaje: en sus últimas conferencias, publicadas después de su muerte como *Postcapitalist Desire* (2020), defendió la renta básica universal como la política concreta que convertiría la automatización en tiempo libre en vez de en desempleo. Es el mismo argumento, con otro nombre, que la lámina de renta básica del material original de este curso ya insinuaba sin desarrollarlo.
