---
id: imaginar-la-maquina
title: Imaginar la máquina
nav_title: Imaginar la máquina
summary: Los mitos, los autómatas y la ficción que imaginaron la vida artificial siglos antes de que existiera la computación.
status: ready
estimated_time: 12m
tags: [mitologia, filosofia, ficcion]
prerequisites: [historia-ia]
---

# Imaginar la máquina

::: figure {#tiempo-mitos title="Línea del tiempo de la sección"}
![Línea del tiempo de los mitos, de Nuwa a Astroboy](_assets/v1-tramo-mitos.svg)
:::
...
![Plano de dos ejes que ubica a Nuwa, Talos, el Golem, al-Jazari, el Turco Mecánico, Frankenstein y R.U.R. según su fecha de atestiguación y la ansiedad que codifican](_assets/v2-mapa-mitos.svg)
:::
...
![Frontispicio de la edición de 1831 de Frankenstein, con la criatura y Victor Frankenstein huyendo](_assets/foto-frankenstein.jpg)
:::

::: figure {#rur title="Cartel de una producción de R.U.R."}
![Cartel del Federal Theatre para una producción de R.U.R. de Karel Čapek](_assets/foto-rur.jpg)
:::
